CREATE OR REPLACE FUNCTION public.get_marchi_stats(p_azienda_nome text DEFAULT NULL::text, p_mese_da integer DEFAULT NULL::integer, p_mese_a integer DEFAULT NULL::integer, p_agente text DEFAULT NULL::text)
 RETURNS json
 LANGUAGE plpgsql
